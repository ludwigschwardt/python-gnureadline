...
/* Don't include internal Python header files - see workaround below
#include "pycore_critical_section.h"// Py_BEGIN_CRITICAL_SECTION()
#include "pycore_modsupport.h"    // _PyArg_CheckPositional(), _PyArg_BadArgument()
*/
/* Include public version of critical section API instead */
#include "critical_section.h"  // Py_BEGIN_CRITICAL_SECTION()
...
PyAPI_FUNC(void) _PyArg_BadArgument(
    ...
    const char *expected,
    PyObject *arg);
/* end of workarounds for includes from internal headers */
